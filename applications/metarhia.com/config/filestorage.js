application.extCompressed = [
  ...
  'mkv', 'mpeg', 'mpg', 'mpe', 'mov', 'asf', 'wmv', 'vob'
];

application.extNotCompressed = [
  'txt', 'pdf', 'doc', 'dot', 'xls', 'ppt', 'rtf', 'hlp', 'inf',
  'eml', 'uu', 'uue',
  'css', 'htm', 'html', 'xhtml', 'tpl', 'vsd', 'chm', 'ps',
  'bmp', 'ico', 'eps', 'svg', 'psd', 'ai', 'tif', 'tiff', 'wmf', 'emf',
  'ani', 'cur', 'wav', 'wave', 'mid',
  'bak', 'sql', 'csv', 'xml', 'rss', 'atom', 'url', 'torrent',
  'bas', 'js', 'php', 'pl', 'pm', 'py', 'c', 'cpp', 'cs', 'd', 'e', 'h', 'inc',
